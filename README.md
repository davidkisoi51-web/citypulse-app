...
* **Event Details Modal/Drawer:** In-depth view featuring venue geolocation addesses, high-res posters, and direct ticketing access.
...
| Name | Role | Core Deliverables | GitHub Username |
| :--- | :--- | :--- | :--- |
| **David Kisoi**  | Role 4: Event Detail Modal | Modal / Drawer Component, UX Lead, Repo Maintainer | [@davidkisoi51-web](https://github.com/davidkisoi51-web) |
